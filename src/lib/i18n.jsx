...
const en = {
  ...
  leagues: {
    ...
    dragHint: 'Drag clubs from the pool below into the table to predict the final standings.',
...
const es = {
  ...
  leagues: {
    ...
    dragHint: 'Arrastra los clubes del grupo de abajo a la tabla para predecir la clasificación final.',
...
const pt = {
  ...
  leagues: {
    ...
    dragHint: 'Arraste os clubes do grupo abaixo para a tabela para prever a classificação final.',
...
const fr = {
  ...
  leagues: {
    ...
    inProgress: 'En Cours',
    dragHint: 'Glissez les clubs du groupe ci-dessous dans le tableau pour prédire le classement final.',
...
const de = {
  ...
  leagues: {
    ...
    dragHint: 'Ziehe Klubs aus dem Pool unten in die Tabelle, um die Endplatzierung vorherzusagen.',
