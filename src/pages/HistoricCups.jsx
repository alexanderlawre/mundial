        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          {[...HISTORIC_WORLD_CUPS].reverse().map((cup) => (
            <button
              ...
              className="rounded-2xl bg-white shadow-depth p-5 text-left hover:-translate-y-1 active:scale-[0.98] transition-all"
            >
              <p className="font-display text-3xl font-extrabold text-emerald">{cup.year}</p>
              <p className="text-charcoal-600 text-sm mt-1">{cup.host}</p>
